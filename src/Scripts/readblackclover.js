function readblackcloverF() {
    ...
    if(document.querySelector("div.bg-bg-secondary > div.grid") !== null){
        rows = document.querySelectorAll("div.bg-bg-secondary > div.grid");
        if(allChaptersPage){
            addNote();
            addBatchDownload();
        }
    ...
    function addNote(){
        let chapterDiv = document.querySelector("div.bg-bg-secondary > div.grid").parentElement;
